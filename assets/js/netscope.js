    ...
    for (i = 0, len = ref.length; i < len; i++) {
      ...
      switch (layertype) {
        ...
        case "pooling":
          ...
          ceil_mode = ((ref30 = params.ceil_mode) != null ? ref30 : 'true') === 'true';
          d.chOut = d.chIn;
          // according to http://caffe.berkeleyvision.org/tutorial/layers.html and https://github.com/BVLC/caffe/issues/3656
          if (ceil_mode) {
        ...
        case "upsample":
          ...
          scale = (ref56 = params.scale) != null ? ref56 : 2;
          d.wOut = d.wIn * scale;
          d.hOut = d.hIn * scale;
          d.chOut = d.chIn;
          d.batchOut = d.batchIn;
        ...
        case "implicit":
          ...
          d.wIn = (ref57 = d.wIn) != null ? ref57 : "?";
          d.hIn = (ref58 = d.hIn) != null ? ref58 : "?";
          d.chIn = (ref59 = d.chIn) != null ? ref59 : "?";
          d.batchIn = (ref60 = d.batchIn) != null ? ref60 : "?";
          //# assume pass-through
          d.wOut = d.wIn;
          d.hOut = d.hIn;
          d.chOut = d.chIn;
        ...
        case "power":
          ...
          power = (ref61 = params.power) != null ? ref61 : 1;
          scale = (ref62 = params.scale) != null ? ref62 : 1;
          shift = (ref63 = params.shift) != null ? ref63 : 0;
        ...
        case "priorbox":
          ...
          min_size = (ref64 = settings.min_size) != null ? ref64 : [];
          max_size = (ref65 = settings.max_size) != null ? ref65 : [];
          num_min = typeof min_size === 'number' ? 1 : min_size.length;
          num_max = typeof max_size === 'number' ? 1 : max_size.length;
          flip = ((ref66 = settings.flip) != null ? ref66 : 'false') === 'true';
        ...
        //memory
        case "proposal":
          num_region_proposals = (ref67 = n.attribs.proposal_param.rpn_post_nms_topn) != null ? ref67 : 100;
          //output dimensions:
          d.wOut = d.hOut = 1;
